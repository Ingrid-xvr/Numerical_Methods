...
for n in refinement_levels:
    interval = Interval(0, 2, trapezoidal_rule, n)
...
for n in refinement_levels:
    interval = Interval(0, 2, simpson_rule, n)
...
for n in refinement_levels:
    interval = Interval(0, 2, simpson_3_8_rule, n)
...
h = [2,1,0.5,0.25,0.125,0.0625,0.03125,0.015625,0.0078125,0.00390625]
...
# for rate in convergence_rates_trap:
#     print(rate)

# print("Trapezio")
# print("h\t\tNumerical Integration\t\tIntegration Errors\t\tConvergence Rate")
# for i in range(len(h)):
#     print(f"{h[i]} & {numerical_integrals_trap[i]} & {integration_errors_trap[i]} & {convergence_rates_trap[i-1]}")
...
# #Print the convergence rates
# print("Convergence rates:")
# for rate in convergence_rates_simp:
#     print(rate)

# print("Simpson")
# print("h\t\tNumerical Integration\t\tIntegration Errors\t\tConvergence Rate")
# for i in range(len(h)):
#     print(f"{h[i]} & {numerical_integrals_simp[i]} & {integration_errors_simp[i]} & {convergence_rates_simp[i-1]}")


# print("Simpson_3_8")
# print("N° Ref.\t\th\t\tNumerical Integration\t\tIntegration Errors\t\tConvergence Rate")
# for i in range(len(h)):
#     print(f"{refinement_levels[i]} & {h[i]} & {numerical_integrals_simp_3_8[i]} & {integration_errors_simp_3_8[i]} & {convergence_rates_simp_3_8[i-1]}")
