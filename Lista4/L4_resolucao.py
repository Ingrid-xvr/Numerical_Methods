...
with open('rhs.dat', 'r') as file:
    ...
    B = [float(re.findall(r'[-+]?\d*\.\d+|[-+]?\d+', linha)[0]) for linha in linhas if re.findall(r'[-+]?\d*\.\d+|[-+]?\d+', linha)]
...
y_data = [
    (resnorm_jacobi_itera, 'resnorm_jacobi_itera', '/home/ingrid/L4/Figuras/jacobi_iter.pdf'),
    (resnorm_ssor, 'resnorm_ssor', '/home/ingrid/L4/Figuras/ssor.pdf'),
    (resnorm_grad, 'resnorm_grad', '/home/ingrid/L4/Figuras/grad.pdf'),
    (resnorm_jacobi_p, 'resnorm_jacobi_p', '/home/ingrid/L4/Figuras/jacobi_p.pdf'),
    (resnorm_ssor_p, 'resnorm_ssor_p', '/home/ingrid/L4/Figuras/ssor_p.pdf')
]
...
plt.grid(True)
plt.tight_layout()
plt.savefig('/home/ingrid/L4/Figuras/completo.pdf', format='pdf')
plt.close()
